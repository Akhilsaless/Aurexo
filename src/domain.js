...
export const DEFAULT_SETTINGS = {
  ...
  approvalRequired: true, budgetMode: 'Economy', monthlyBudget: 2500, postsPerDay: 2,
  ...
  providers: {video:'hybrid-local', voice:'browser-tts', render:'hybrid', ai:'ai-hub'},
  zeroCostLock: true,
  integrationFlags: {
    ai: defaultIntegrationFlags(AI_INTEGRATIONS),
    video: defaultIntegrationFlags(VIDEO_INTEGRATIONS),
    voice: defaultIntegrationFlags(VOICE_INTEGRATIONS),
    storage: defaultIntegrationFlags(STORAGE_INTEGRATIONS)
  },
